...
procedure {:inline 1} $cafe_BasicCoin_balance_of'#0'(_$t0: int) returns ($ret0: int)
{
    ...
    assume {:print "$at(12,1275,1276)"} true;
    ...
    assume {:print "$at(12,1355,1368)"} true;
    ...
    assume {:print "$at(12,1410,1411)"} true;
L1:
...
L1:
    ...
    // assert Not(false) at ./sources/BasicCoin.move:35:5+1
    assume {:print "$at(12,1410,1411)"} true;
    assert {:msg "assert_failed(12,1410,1411): function does not abort under this condition"}
      !false;
...
L2:
    ...
    // assert false at ./sources/BasicCoin.move:37:5+59
    assume {:print "$at(12,1417,1476)"} true;
    assert {:msg "assert_failed(12,1417,1476): abort not covered by any of the `aborts_if` clauses"}
      false;

    // abort($t2) at ./sources/BasicCoin.move:37:5+59
    $abort_code := $t2;
    $abort_flag := true;
    return;
...
// fun BasicCoin::deposit<#0> [baseline] at ./sources/BasicCoin.move:56:5+295
procedure {:inline 1} $cafe_BasicCoin_deposit'#0'(_$t0: int, _$t1: $cafe_BasicCoin_Coin'#0') returns ()
{
    ...
    // bytecode translation starts here
    // trace_local[addr]($t0) at ./sources/BasicCoin.move:56:5+1
    assume {:print "$at(12,2286,2287)"} true;
    assume {:print "$track_local(1,1,0):", $t0} $t0 == $t0;

    // trace_local[check]($t1) at ./sources/BasicCoin.move:56:5+1
    assume {:print "$track_local(1,1,1):", $t1} $t1 == $t1;

    // $t5 := BasicCoin::balance_of<#0>($t0) on_abort goto L2 with $t6 at ./sources/BasicCoin.move:57:23+26
    assume {:print "$at(12,2386,2412)"} true;
    ...
    // trace_local[balance]($t5) at ./sources/BasicCoin.move:57:13+7
    assume {:print "$track_local(1,1,2):", $t5} $t5 == $t5;

    // $t7 := borrow_global<BasicCoin::Balance<#0>>($t0) on_abort goto L2 with $t6 at ./sources/BasicCoin.move:58:32+17
    assume {:print "$at(12,2445,2462)"} true;
    if (!$ResourceExists($cafe_BasicCoin_Balance'#0'_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
    ...
    // $t8 := borrow_field<BasicCoin::Balance<#0>>.coin($t7) at ./sources/BasicCoin.move:58:32+47
    $t8 := $ChildMutation($t7, 0, $coin#$cafe_BasicCoin_Balance'#0'($Dereference($t7)));

    // $t9 := borrow_field<BasicCoin::Coin<#0>>.value($t8) at ./sources/BasicCoin.move:58:27+58
    $t9 := $ChildMutation($t8, 0, $value#$cafe_BasicCoin_Coin'#0'($Dereference($t8)));

    // trace_local[balance_ref]($t9) at ./sources/BasicCoin.move:58:13+11
    $temp_0'u64' := $Dereference($t9);
    assume {:print "$track_local(1,1,3):", $temp_0'u64'} $temp_0'u64' == $temp_0'u64';

    // $t10 := unpack BasicCoin::Coin<#0>($t1) at ./sources/BasicCoin.move:59:13+14
    assume {:print "$at(12,2512,2526)"} true;
    $t10 := $value#$cafe_BasicCoin_Coin'#0'($t1);

    // trace_local[value]($t10) at ./sources/BasicCoin.move:59:20+5
    assume {:print "$track_local(1,1,4):", $t10} $t10 == $t10;

    // $t11 := +($t5, $t10) on_abort goto L2 with $t6 at ./sources/BasicCoin.move:60:32+1
    assume {:print "$at(12,2567,2568)"} true;
    ...
    // write_ref($t9, $t11) at ./sources/BasicCoin.move:60:9+30
    $t9 := $UpdateMutation($t9, $t11);

    // write_back[Reference($t8).value (u64)]($t9) at ./sources/BasicCoin.move:60:9+30
    $t8 := $UpdateMutation($t8, $Update'$cafe_BasicCoin_Coin'#0''_value($Dereference($t8), $Dereference($t9)));

    // write_back[Reference($t7).coin (BasicCoin::Coin<#0>)]($t8) at ./sources/BasicCoin.move:60:9+30
    $t7 := $UpdateMutation($t7, $Update'$cafe_BasicCoin_Balance'#0''_coin($Dereference($t7), $Dereference($t8)));

    // write_back[BasicCoin::Balance<#0>@]($t7) at ./sources/BasicCoin.move:60:9+30
    $cafe_BasicCoin_Balance'#0'_$memory := $ResourceUpdate($cafe_BasicCoin_Balance'#0'_$memory, $GlobalLocationAddress($t7),
        $Dereference($t7));

    // label L1 at ./sources/BasicCoin.move:61:5+1
    assume {:print "$at(12,2580,2581)"} true;
L1:

    // return () at ./sources/BasicCoin.move:61:5+1
    assume {:print "$at(12,2580,2581)"} true;
    return;

    // label L2 at ./sources/BasicCoin.move:61:5+1
L2:

    // abort($t6) at ./sources/BasicCoin.move:61:5+1
    assume {:print "$at(12,2580,2581)"} true;
    $abort_code := $t6;
    $abort_flag := true;
    return;
...
// fun BasicCoin::deposit [verification] at ./sources/BasicCoin.move:56:5+295
procedure {:timeLimit 40} $cafe_BasicCoin_deposit$verify(_$t0: int, _$t1: $cafe_BasicCoin_Coin'#0') returns ()
{
    ...
    // assume forall $rsc: ResourceDomain<BasicCoin::Balance<#0>>(): WellFormed($rsc) at ./sources/BasicCoin.move:56:5+1
    assume (forall $a_0: int :: {$ResourceValue($cafe_BasicCoin_Balance'#0'_$memory, $a_0)}(var $rsc := $ResourceValue($cafe_BasicCoin_Balance'#0'_$memory, $a_0);
    ($IsValid'$cafe_BasicCoin_Balance'#0''($rsc))));
...
procedure {:timeLimit 40} $cafe_BasicCoin_mint$verify(_$t0: int, _$t1: int, _$t2: #0) returns ()
{
    ...
    assume {:print "$at(12,1025,1026)"} true;
    assume $IsValid'address'($t0);
    ...
    // assume forall $rsc: ResourceDomain<BasicCoin::Balance<#0>>(): WellFormed($rsc) at ./sources/BasicCoin.move:28:5+1
    assume (forall $a_0: int :: {$ResourceValue($cafe_BasicCoin_Balance'#0'_$memory, $a_0)}(var $rsc := $ResourceValue($cafe_BasicCoin_Balance'#0'_$memory, $a_0);
    ($IsValid'$cafe_BasicCoin_Balance'#0''($rsc))));
    ...
    assume {:print "$at(12,1229,1261)"} true;
    ...
    if ($abort_flag) {
        assume {:print "$at(12,1210,1262)"} true;
        $t4 := $abort_code;
    ...
    assume {:print "$at(12,1268,1269)"} true;
L1:
...
procedure {:timeLimit 40} $cafe_BasicCoin_publish_balance$verify(_$t0: $signer) returns ()
{
    ...
    assume {:print "$at(12,570,571)"} true;
    assume $IsValid'signer'($t0) && $1_signer_is_txn_signer($t0) && $1_signer_is_txn_signer_addr($addr#$signer($t0));

    // assume forall $rsc: ResourceDomain<BasicCoin::Balance<#0>>(): WellFormed($rsc) at ./sources/BasicCoin.move:20:5+1
    assume (forall $a_0: int :: {$ResourceValue($cafe_BasicCoin_Balance'#0'_$memory, $a_0)}(var $rsc := $ResourceValue($cafe_BasicCoin_Balance'#0'_$memory, $a_0);
    ($IsValid'$cafe_BasicCoin_Balance'#0''($rsc))));
    ...
    // $t2 := signer::address_of($t0) on_abort goto L3 with $t3 at ./sources/BasicCoin.move:22:44+27
    assume {:print "$at(12,724,751)"} true;
    ...
    // $t4 := exists<BasicCoin::Balance<#0>>($t2) at ./sources/BasicCoin.move:22:18+6
    $t4 := $ResourceExists($cafe_BasicCoin_Balance'#0'_$memory, $t2);

    // $t5 := !($t4) at ./sources/BasicCoin.move:22:17+1
    call $t5 := $Not($t4);

    // if ($t5) goto L0 else goto L1 at ./sources/BasicCoin.move:22:9+86
    if ($t5) { goto L0; } else { goto L1; }

    // label L1 at ./sources/BasicCoin.move:22:9+86
L1:

    // $t6 := 2 at ./sources/BasicCoin.move:22:74+20
    assume {:print "$at(12,754,774)"} true;
    $t6 := 2;
    assume $IsValid'u64'($t6);

    // trace_abort($t6) at ./sources/BasicCoin.move:22:9+86
    assume {:print "$at(12,689,775)"} true;
    assume {:print "$track_abort(1,3):", $t6} $t6 == $t6;

    // $t3 := move($t6) at ./sources/BasicCoin.move:22:9+86
    $t3 := $t6;

    // goto L3 at ./sources/BasicCoin.move:22:9+86
    goto L3;

    // label L0 at ./sources/BasicCoin.move:23:17+7
    assume {:print "$at(12,793,800)"} true;
L0:

    // $t7 := 0 at ./sources/BasicCoin.move:21:50+1
    assume {:print "$at(12,676,677)"} true;
    $t7 := 0;
    assume $IsValid'u64'($t7);

    // $t8 := pack BasicCoin::Coin<#0>($t7) at ./sources/BasicCoin.move:21:26+27
    $t8 := $cafe_BasicCoin_Coin'#0'($t7);

    // $t9 := pack BasicCoin::Balance<#0>($t8) at ./sources/BasicCoin.move:23:26+38
    assume {:print "$at(12,802,840)"} true;
    $t9 := $cafe_BasicCoin_Balance'#0'($t8);

    // move_to<BasicCoin::Balance<#0>>($t9, $t0) on_abort goto L3 with $t3 at ./sources/BasicCoin.move:23:9+7
    ...
    if ($abort_flag) {
        assume {:print "$at(12,785,792)"} true;
        $t3 := $abort_code;
        assume {:print "$track_abort(1,3):", $t3} $t3 == $t3;
        goto L3;
    }

    // label L2 at ./sources/BasicCoin.move:24:5+1
    assume {:print "$at(12,847,848)"} true;
L2:
...
L3:
    ...
    // abort($t3) at ./sources/BasicCoin.move:24:5+1
    assume {:print "$at(12,847,848)"} true;
    $abort_code := $t3;
    $abort_flag := true;
    return;
...
// fun BasicCoin::transfer [verification] at ./sources/BasicCoin.move:43:5+233
procedure {:timeLimit 40} $cafe_BasicCoin_transfer$verify(_$t0: $signer, _$t1: int, _$t2: int, _$t3: #0) returns ()
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at ./sources/BasicCoin.move:43:5+1
    assume {:print "$at(12,1672,1673)"} true;
    assume $IsValid'signer'($t0) && $1_signer_is_txn_signer($t0) && $1_signer_is_txn_signer_addr($addr#$signer($t0));

    // assume WellFormed($t1) at ./sources/BasicCoin.move:43:5+1
    assume $IsValid'address'($t1);

    // assume WellFormed($t2) at ./sources/BasicCoin.move:43:5+1
    assume $IsValid'u64'($t2);

    // assume WellFormed($t3) at ./sources/BasicCoin.move:43:5+1
    assume $IsValid'#0'($t3);

    // assume forall $rsc: ResourceDomain<BasicCoin::Balance<#0>>(): WellFormed($rsc) at ./sources/BasicCoin.move:43:5+1
    assume (forall $a_0: int :: {$ResourceValue($cafe_BasicCoin_Balance'#0'_$memory, $a_0)}(var $rsc := $ResourceValue($cafe_BasicCoin_Balance'#0'_$memory, $a_0);
    ($IsValid'$cafe_BasicCoin_Balance'#0''($rsc))));

    // trace_local[from]($t0) at ./sources/BasicCoin.move:43:5+1
    assume {:print "$track_local(1,4,0):", $t0} $t0 == $t0;

    // trace_local[to]($t1) at ./sources/BasicCoin.move:43:5+1
    assume {:print "$track_local(1,4,1):", $t1} $t1 == $t1;

    // trace_local[amount]($t2) at ./sources/BasicCoin.move:43:5+1
    assume {:print "$track_local(1,4,2):", $t2} $t2 == $t2;

    // trace_local[_witness]($t3) at ./sources/BasicCoin.move:43:5+1
    assume {:print "$track_local(1,4,3):", $t3} $t3 == $t3;

    // $t5 := signer::address_of($t0) on_abort goto L2 with $t6 at ./sources/BasicCoin.move:44:40+24
    assume {:print "$at(12,1827,1851)"} true;
    ...
    // $t7 := BasicCoin::withdraw<#0>($t5, $t2) on_abort goto L2 with $t6 at ./sources/BasicCoin.move:44:21+52
    call $t7 := $cafe_BasicCoin_withdraw'#0'($t5, $t2);
    if ($abort_flag) {
        assume {:print "$at(12,1808,1860)"} true;
        $t6 := $abort_code;
        assume {:print "$track_abort(1,4):", $t6} $t6 == $t6;
        goto L2;
    }

    // trace_local[check]($t7) at ./sources/BasicCoin.move:44:13+5
    assume {:print "$track_local(1,4,4):", $t7} $t7 == $t7;

    // BasicCoin::deposit<#0>($t1, $t7) on_abort goto L2 with $t6 at ./sources/BasicCoin.move:45:9+28
    assume {:print "$at(12,1870,1898)"} true;
    ...
    // label L1 at ./sources/BasicCoin.move:46:5+1
    assume {:print "$at(12,1904,1905)"} true;
L1:

    // return () at ./sources/BasicCoin.move:46:5+1
    assume {:print "$at(12,1904,1905)"} true;
    return;

    // label L2 at ./sources/BasicCoin.move:46:5+1
L2:

    // abort($t6) at ./sources/BasicCoin.move:46:5+1
    assume {:print "$at(12,1904,1905)"} true;
    $abort_code := $t6;
    $abort_flag := true;
    return;
...
// fun BasicCoin::withdraw<#0> [baseline] at ./sources/BasicCoin.move:48:5+369
procedure {:inline 1} $cafe_BasicCoin_withdraw'#0'(_$t0: int, _$t1: int) returns ($ret0: $cafe_BasicCoin_Coin'#0')
{
    ...
    // bytecode translation starts here
    // trace_local[addr]($t0) at ./sources/BasicCoin.move:48:5+1
    assume {:print "$at(12,1911,1912)"} true;
    assume {:print "$track_local(1,5,0):", $t0} $t0 == $t0;

    // trace_local[amount]($t1) at ./sources/BasicCoin.move:48:5+1
    assume {:print "$track_local(1,5,1):", $t1} $t1 == $t1;

    // $t4 := BasicCoin::balance_of<#0>($t0) on_abort goto L3 with $t5 at ./sources/BasicCoin.move:49:23+26
    assume {:print "$at(12,2020,2046)"} true;
    ...
    // trace_local[balance]($t4) at ./sources/BasicCoin.move:49:13+7
    assume {:print "$track_local(1,5,2):", $t4} $t4 == $t4;

    // $t6 := >=($t4, $t1) at ./sources/BasicCoin.move:50:25+2
    assume {:print "$at(12,2072,2074)"} true;
    call $t6 := $Ge($t4, $t1);

    // if ($t6) goto L0 else goto L1 at ./sources/BasicCoin.move:50:9+49
    if ($t6) { goto L0; } else { goto L1; }

    // label L1 at ./sources/BasicCoin.move:50:36+21
L1:

    // $t7 := 1 at ./sources/BasicCoin.move:50:36+21
    assume {:print "$at(12,2083,2104)"} true;
    $t7 := 1;
    assume $IsValid'u64'($t7);

    // trace_abort($t7) at ./sources/BasicCoin.move:50:9+49
    assume {:print "$at(12,2056,2105)"} true;
    assume {:print "$track_abort(1,5):", $t7} $t7 == $t7;

    // $t5 := move($t7) at ./sources/BasicCoin.move:50:9+49
    $t5 := $t7;

    // goto L3 at ./sources/BasicCoin.move:50:9+49
    goto L3;

    // label L0 at ./sources/BasicCoin.move:51:69+4
    assume {:print "$at(12,2175,2179)"} true;
L0:

    // $t8 := borrow_global<BasicCoin::Balance<#0>>($t0) on_abort goto L3 with $t5 at ./sources/BasicCoin.move:51:32+17
    assume {:print "$at(12,2138,2155)"} true;
    if (!$ResourceExists($cafe_BasicCoin_Balance'#0'_$memory, $t0)) {
        call $ExecFailureAbort();
    } else {
    ...
    // $t9 := borrow_field<BasicCoin::Balance<#0>>.coin($t8) at ./sources/BasicCoin.move:51:32+47
    $t9 := $ChildMutation($t8, 0, $coin#$cafe_BasicCoin_Balance'#0'($Dereference($t8)));

    // $t10 := borrow_field<BasicCoin::Coin<#0>>.value($t9) at ./sources/BasicCoin.move:51:27+58
    $t10 := $ChildMutation($t9, 0, $value#$cafe_BasicCoin_Coin'#0'($Dereference($t9)));

    // trace_local[balance_ref]($t10) at ./sources/BasicCoin.move:51:13+11
    $temp_0'u64' := $Dereference($t10);
    assume {:print "$track_local(1,5,3):", $temp_0'u64'} $temp_0'u64' == $temp_0'u64';

    // $t11 := -($t4, $t1) on_abort goto L3 with $t5 at ./sources/BasicCoin.move:52:32+1
    assume {:print "$at(12,2224,2225)"} true;
    call $t11 := $Sub($t4, $t1);
    if ($abort_flag) {
        assume {:print "$at(12,2224,2225)"} true;
        $t5 := $abort_code;
    ...
    // write_ref($t10, $t11) at ./sources/BasicCoin.move:52:9+31
    $t10 := $UpdateMutation($t10, $t11);

    // write_back[Reference($t9).value (u64)]($t10) at ./sources/BasicCoin.move:52:9+31
    $t9 := $UpdateMutation($t9, $Update'$cafe_BasicCoin_Coin'#0''_value($Dereference($t9), $Dereference($t10)));

    // write_back[Reference($t8).coin (BasicCoin::Coin<#0>)]($t9) at ./sources/BasicCoin.move:52:9+31
    $t8 := $UpdateMutation($t8, $Update'$cafe_BasicCoin_Balance'#0''_coin($Dereference($t8), $Dereference($t9)));

    // write_back[BasicCoin::Balance<#0>@]($t8) at ./sources/BasicCoin.move:52:9+31
    $cafe_BasicCoin_Balance'#0'_$memory := $ResourceUpdate($cafe_BasicCoin_Balance'#0'_$memory, $GlobalLocationAddress($t8),
        $Dereference($t8));

    // $t12 := pack BasicCoin::Coin<#0>($t1) at ./sources/BasicCoin.move:53:9+32
    assume {:print "$at(12,2242,2274)"} true;
    $t12 := $cafe_BasicCoin_Coin'#0'($t1);

    // trace_return[0]($t12) at ./sources/BasicCoin.move:53:9+32
    assume {:print "$track_return(1,5,0):", $t12} $t12 == $t12;

    // label L2 at ./sources/BasicCoin.move:54:5+1
    assume {:print "$at(12,2279,2280)"} true;
L2:

    // return $t12 at ./sources/BasicCoin.move:54:5+1
    assume {:print "$at(12,2279,2280)"} true;
    $ret0 := $t12;
    return;

    // label L3 at ./sources/BasicCoin.move:54:5+1
L3:

    // abort($t5) at ./sources/BasicCoin.move:54:5+1
    assume {:print "$at(12,2279,2280)"} true;
    $abort_code := $t5;
    $abort_flag := true;
    return;
...
// fun BasicCoin::withdraw [verification] at ./sources/BasicCoin.move:48:5+369
procedure {:timeLimit 40} $cafe_BasicCoin_withdraw$verify(_$t0: int, _$t1: int) returns ($ret0: $cafe_BasicCoin_Coin'#0')
{
    ...
    // bytecode translation starts here
    // assume WellFormed($t0) at ./sources/BasicCoin.move:48:5+1
    assume {:print "$at(12,1911,1912)"} true;
    assume $IsValid'address'($t0);

    // assume WellFormed($t1) at ./sources/BasicCoin.move:48:5+1
    assume $IsValid'u64'($t1);

    // assume forall $rsc: ResourceDomain<BasicCoin::Balance<#0>>(): WellFormed($rsc) at ./sources/BasicCoin.move:48:5+1
    assume (forall $a_0: int :: {$ResourceValue($cafe_BasicCoin_Balance'#0'_$memory, $a_0)}(var $rsc := $ResourceValue($cafe_BasicCoin_Balance'#0'_$memory, $a_0);
    ($IsValid'$cafe_BasicCoin_Balance'#0''($rsc))));
