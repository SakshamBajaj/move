...
use crate::options::RapidOptions;
...
#[derive(Debug, Clone)]
pub struct RunRapidWithSeeds {
    pub options: RapidOptions,
    pub rapid_file: String,
}

#[async_trait]
impl ProverTask for RunRapidWithSeeds {
...
impl RunRapidWithSeeds {
    /// Returns command line to call boogie.
    pub fn get_rapid_command(&mut self) -> anyhow::Result<Vec<String>> {
        self.options.get_rapid_command(&self.rapid_file);
    }
