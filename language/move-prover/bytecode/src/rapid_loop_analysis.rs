...
pub struct RapidLoopAnalysisProcessor {}

impl RapidLoopAnalysisProcessor {
    pub fn new() -> Box<Self> {
        Box::new(RapidLoopAnalysisProcessor {})
    }
}

impl FunctionTargetProcessor for RapidLoopAnalysisProcessor {
    fn process(
        &self,
